import MustHaveCard from "@/app/components/MustHaveCard";
		...
		<div className="text-white pb-4">
			<div className="relative h-[70vh]">
				...
				<div className="absolute  text-center top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white">
					<h1 className="sm:text-4xl  2xl:text-6xl font-bold">
						Votre guide pour découvrir la magie de Paris
					</h1>
					<h2 className="text-xs 2xl:text-xl font-bold my-8 2xl:my-12">
						De l&apos;élégance des monuments historiques aux rues
						pittoresques, plongez dans le cœur vibrant de la
						capitale française
					</h2>
					<button className="bg-sky-900 text-xs px-4 py-2 mt-2 rounded-2xl text-white font-bold hover:bg-sky-800 mr-4">
						Planifiez votre visite
					</button>
					<button className="bg-sky-900 text-xs px-4 py-2 mt-2 rounded-2xl text-white font-bold hover:bg-sky-800">
